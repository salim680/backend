...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $newApp = [
        ...
        'hoursImage' => $hoursImage ? $frontendBase . 'https://aladlyfamily.kesug.com/uploads/applications/' . $hoursImage : null,
        'historyImage' => $historyImage ? $frontendBase . 'https://aladlyfamily.kesug.com/uploads/applications/' . $historyImage : null,
        'extraImage' => $extraImage ? $frontendBase . 'https://aladlyfamily.kesug.com/uploads/applications/' . $extraImage : null,
